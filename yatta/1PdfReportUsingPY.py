...
# Expand file paths
input_path = os.path.expanduser('~/Desktop/yatta-26-06-2025/26-06-2025 توزيع غياب يطا.xlsx')
output_path = os.path.expanduser('~/Desktop/yatta-26-06-2025/26-06 توزيع غياب يطا منسق.xlsx')
