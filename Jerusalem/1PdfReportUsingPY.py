...
# Expand file paths
input_path = os.path.expanduser('~/Desktop/jerusalem-26-06-2025/26-06-2025 توزيع غياب القدس.xlsx')
output_path = os.path.expanduser('~/Desktop/jerusalem-26-06-2025/26-06 توزيع غياب القدس منسق.xlsx')
