...
$excelFilePath  = "$Home\Desktop\GovSchools.xlsx"  # Replace with your CSV file path
$pdfFilePath = "$Home\Desktop\GovSchools.pdf"  # Output PDF file path
...
$worksheet.PageSetup.Orientation = 1  # 1 = Portrait orientation, 2 = Landscape orientation
...
$worksheet.PageSetup.CenterHeader ="&30 &B قائمة المدارس الحكومية المشاركة `n في المسابقات"  # "Page X of Y" format
