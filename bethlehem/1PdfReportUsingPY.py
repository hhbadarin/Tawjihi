...
# Expand file paths
input_path = os.path.expanduser('~/Desktop/bethlehem-26-06-2025/26-06-2025 توزيع غياب بيت لحم.xlsx')
output_path = os.path.expanduser('~/Desktop/bethlehem-26-06-2025/26-06 توزيع غياب بيت لحم منسق.xlsx')
